...
#API Key connection
def Api_connect():
    Api_id = "AIzaSyCjBJ9BPQEgKl6v_keOBHsSEbZbFSSv9Ys"
...
def get_video_ids(channel_id):
    ...
    while True:
        ...
        next_page_token = response1.get("nextPageToken")  # if token is available get the token or it will return none
...
# upload to mongo db
client=pymongo.MongoClient("mongodb+srv://janakikv2:janaki@cluster0.1d68pum.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
def tables(channel_name):
    ...
    isExists= channels_table(channel_name)
    if isExists:
        st.write(isExists)
    else:
